...
class GreenFilterTransformer[Env, InDown, OutUp, OutDown, InUp](underlying: Filter[InDown, OutUp, OutDown, InUp])
  extends Filter[(Env, InDown), OutUp, (Env, OutDown), InUp] {
